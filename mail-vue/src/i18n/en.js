const en = {
    ...
    admin: 'Admin',
    addUser: 'Add User',
    batchRandomUsers: 'Batch Random Emails',
    ...
    batchFailed: 'Failed',
    batchCreateResult: 'Completed: {success} succeeded, {failed} failed',
    emptyDomain: 'Domain is required',
    verificationCodeApi: 'Verification Code API',
    copyApiUrl: 'Copy API URL',
    mailboxApiNotice: 'This URL is a mailbox secret. It can only read the latest code for this mailbox. Do not share it.',
    select: 'Select',
    unknown: 'Unknown',
